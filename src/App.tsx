          ...
          <div className="animate-fadeInUp" style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(360px, 1fr))', gap: '24px' }}>
              ...
              <div className="glass-panel" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                ...
                <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>
                  Abaixo está o roteiro estruturado do dia, garantindo o melhor aproveitamento de conteúdo e dinâmicas de rede.
                </p>

                <div className="timeline">
                  {[
                    { time: '07:30', title: 'Credenciamento', desc: 'Recepção dos participantes, crachás e teste de Wi-Fi' },
                    { time: '08:00', title: 'Abertura & Introdução', desc: 'Boas-vindas com Eduardo Both e Gabriel Müller. Visão geral com palestrante Thiago Diaz.' },
                    { time: '08:30', title: 'Hands-On IA Aplicada', desc: 'Primeiro bloco prático: Construção de assistentes de IA para WhatsApp e CRM' },
                    { time: '10:00', title: 'Coffee Break & Networking', desc: 'Momento de conexão no espaço lounge do auditório' },
                    { time: '10:30', title: 'Continuação Hands-On', desc: 'Segundo bloco: Automação de processos operacionais e integração com n8n' },
                    { time: '12:00', title: 'Networking Rodada de Negócios', desc: 'Apresentação de soluções dos participantes e feedback do time' },
                    { time: '13:00', title: 'Encerramento & Keynotes', desc: 'Palavras finais, fotos oficiais e depoimentos' },
                    { time: '14:00', title: 'Finalização do Evento', desc: 'Despedida geral e liberação do auditório' }
                  ].map((item, idx) => (
